...
#include "../../../Test_1/hex_chess/ChessBoard.h"
...
static constexpr auto qt_meta_stringdata_CLASSChessBoardENDCLASS = QtMocHelpers::stringData(
    "ChessBoard",
    "setPieces",
    "",
    "row",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSChessBoardENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSChessBoardENDCLASS_t qt_meta_stringdata_CLASSChessBoardENDCLASS = {
    {
        QT_MOC_LITERAL(0, 10),  // "ChessBoard"
        QT_MOC_LITERAL(11, 9),  // "setPieces"
        QT_MOC_LITERAL(21, 0),  // ""
        QT_MOC_LITERAL(22, 3),  // "row"
        QT_MOC_LITERAL(26, 3),  // "col"
        QT_MOC_LITERAL(30, 9)   // "AIWorking"
    },
    "ChessBoard",
    "setPieces",
    "",
...
void ChessBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->setPieces((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        case 1: _t->AIWorking(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &ChessBoard::setPieces; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &ChessBoard::AIWorking; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ChessBoard::setPieces(int _t1, int _t2)
{
